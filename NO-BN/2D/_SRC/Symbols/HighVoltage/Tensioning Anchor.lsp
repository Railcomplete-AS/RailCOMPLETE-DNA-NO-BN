...
(defun STREVERFESTE ( / blockName shaftLength arrowHeight arrowHalfWidth baseHalfWidth )
	...
	(command
		"._LINE" (list 0 0) (list (- arrowHalfWidth) arrowHeight) ""
		"._LINE" (list 0 0) (list (+ arrowHalfWidth) arrowHeight) ""
		"._LINE" (list 0 0) (list 0 shaftLength) ""
...
(defun STREVERFESTE-TUNNEL-120 ( / blockName shaftLength arrowHeight arrowHalfWidth baseHalfWidth )
	...
	(command
		...
		"._PLINE" "0.125,-0.650" "0.125,-0.950" "0.225,-0.950" "0.225,-0.650" "_CLOSE" "" ; right bolt hole plate
		"._CIRCLE" "0.175,-0.685" 0.012 ; upper bolt hole
		"._CIRCLE" "0.175,-0.915" 0.012 ; lower bolt hole
		"._PLINE" "0.225,-0.749" "0.225,-0.851" "0.425,-0.851" "0.375,-0.749" "_CLOSE" ; right part of base plate
		"._PLINE" "0.369,-0.737" "0.431,-0.863" "0.441,-0.858" "0.380,-0.732" "_CLOSE" ; right side-plate of base
		"._PLINE" "0.050,-0.153" "0.366,-0.779" "0.415,-0.754" "0.102,-0.128" "_CLOSE" ; right side spanner
		"._PLINE" "0.028,-0.071" "0.066,-0.146" "0.086,-0.135" "0.049,-0.060" "_CLOSE" ; right side spanner's fastening to clamp ring
		"._MIRROR" "_ALL" "" "0,0" "0,1" "_NO" ; mirror to make left side
		"._PLINE" "-0.125,-0.749""-0.125,-0.851""0.125,-0.851" "0.125,-0.749" "_CLOSE" ; baseplate center part
