...
(defun NO-BN-2D-JBTFE-ETIKETT-A-1-0-VLB-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-0.6,0" _th180_ _angle90_ _rcTextStyle_ _bottomLeft_ (+ _multipleLines_ _lockPosition_))
...
(defun NO-BN-2D-JBTFE-ETIKETT-B-1-0-HLB-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-10,2.4" _th180_ _angleZero_ _rcTextStyle_ _topLeft_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-B-1-0-HLT-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-10,0.6" _th180_ _angleZero_ _rcTextStyle_ _bottomLeft_ (+ _multipleLines_ _lockPosition_))
...
(defun NO-BN-2D-JBTFE-ETIKETT-B-1-0-HRB-018 ( / blockName )
	...
	(command _LINE_ _origo_ "0,3" "10,3" _ENTER_)
	(addAtt "T01" "T01" "T01" "10,2.4" _th180_ _angleZero_ _rcTextStyle_ _topRight_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-0-HLB-025 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-21.5,3.75" _th250_ _angleZero_ _rcTextStyle_ _bottomLeft_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-0-HLT-025 ( / blockName )
	...
	(command _LINE_ "0,-3" _origo_ "-3,-3" "-21,-3" _ENTER_)
	(addAtt "T01" "T01" "T01" "-21.5,-2.25" _th250_ _angleZero_ _rcTextStyle_ _bottomLeft_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-0-HRB-025 ( / blockName )
	...
	(command _LINE_ "0,3" _origo_ "3,3" "21,3" _ENTER_)
	(addAtt "T01" "T01" "T01" "21.5,3.75" _th250_ _angleZero_ _rcTextStyle_ _BottomRight_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-0-HRT-025 ( / blockName )
	...
	(command _LINE_ "0,-3" _origo_ "3,-3" "21,-3" _ENTER_)
	(addAtt "T01" "T01" "T01" "21.5,-2.25" _th250_ _angleZero_ _rcTextStyle_ _BottomRight_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-1-HLB-025-018 ( / blockName )
	...
	(command _LINE_ "0,3" _origo_ "-3,3" "-21,3" _ENTER_)
	(addAtt "T01" "T01" "T01" "-12.5,3.75" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,2.4" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-1-HLT-025-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-12.5,0.75" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,-0.6" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(command _MOVE_ _selectAll_ _ENTER_ _origo_ "0,-3")
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-2-HLB-025-018 ( / blockName )
  (setq blockName "NO-BN-2D-JBTFE-ETIKETT-C-1-2-HLB-025-018")
	...
	(addAtt "T01" "T01" "T01" "-12.5,3.75" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,2.4" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T03" "T03" "T03" "-12.5,0.4" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-C-1-2-HLT-025-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-12.5,0,75" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,-0.6" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T03" "T03" "T03" "-12.5,-2.6" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(command _MOVE_ _selectAll_ _ENTER_ _origo_ "0,-3")
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-D-1-1-HLB-025-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-12.5,5.25" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,3.9" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-D-1-1-HLT-025-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-12.5,2.25" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,0.9" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
...
(defun NO-BN-2D-JBTFE-ETIKETT-D-1-2-HLB-025-018 ( / blockName )
	...
	(addAtt "T01" "T01" "T01" "-12.5,5.25" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,3.9" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T03" "T03" "T03" "-12.5,1.4" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
...
(defun NO-BN-2D-JBTFE-ETIKETT-D-1-2-HLT-025-018 ( / blockName )
	...
	(command _LINE_ "0,-1.5" "-3,-4.5" "-21,-4.5" _ENTER_)
	(addAtt "T01" "T01" "T01" "-12.5,-3.75" _th250_ _angleZero_ _rcTextStyle_ _BottomCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T02" "T02" "T02" "-12.5,-5.1" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(addAtt "T03" "T03" "T03" "-12.5,-7.6" _th180_ _angleZero_ _rcTextStyle_ _topCenter_ (+ _multipleLines_ _lockPosition_))
	(createSchematicBlockFromCurrentGraphics blockName)
	(createAnnotativeBlockFromScaledSchematicBlock blockName _one_)
)
