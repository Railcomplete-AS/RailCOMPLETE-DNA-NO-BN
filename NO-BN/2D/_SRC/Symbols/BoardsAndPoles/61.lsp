...
(defun 61A ( / blockName description x y TL TR BL BR pt11 pt12 pt13 pt14 )
	...
	(command _POLYLINE_ pt11 pt12 TR TL _closedPolyline_)
	(drawHatch _blackHatch_) 
	(command _POLYLINE_ pt13 pt14 BR BL _closedPolyline_)
	(drawHatch _blackHatch_) 
	(moveUp (halfOf y))
...
(defun 61B ( / blockName description x y TL TR BL BR pt11 pt12 pt13 pt14 pt21 pt22 pt23 pt24 )
	...
	(command _POLYLINE_ pt11 pt12 TR TL _closedPolyline_)
	(drawHatch _blackHatch_) 
	(command _POLYLINE_ pt13 pt14 pt22 pt21 _closedPolyline_)
	(drawHatch _blackHatch_) 
	(command _POLYLINE_ pt23 pt24 BR BL _closedPolyline_)
	(drawHatch _blackHatch_) 
	(moveUp (halfOf y))
	(addDescriptionBelowOrigo description 0)
	(createSchematicBlockFromCurrentGraphics blockName)
...
(defun 61C ( / blockName description x y TL TR BL BR pt11 pt12 pt13 pt14 pt21 pt22 pt23 pt24 pt31 pt32 pt33 pt34 )
	...
	(command _POLYLINE_ pt13 pt14 pt22 pt21 _closedPolyline_)
	(drawHatch _blackHatch_) 
	(command _POLYLINE_ pt23 pt24 pt32 pt31 _closedPolyline_)
	(drawHatch _blackHatch_) 
	(command _POLYLINE_ pt33 pt34 BR BL _closedPolyline_)
	(drawHatch _blackHatch_) 
	(moveUp (halfOf y))
	(addDescriptionBelowOrigo description 0)
	(createSchematicBlockFromCurrentGraphics blockName)
...
(defun E61 ( / blockName description x y TL TR BL BR pt11 pt12 pt13 pt14 )
	...
	(command _POLYLINE_ pt11 pt12 pt14 pt13 _closedPolyline_)
