...
(defun 65A ( / blockName description x y r1 r2 )
	...
	(moveUp (halfOf y))
	(setLayer layer_Zero)
	(command "._PLINE" p11 p12 p22 p21 _closed_)
	(drawHatchFromPoint _filledHatch_ (list 0 (* 0.1 y)) 0 0)
...
(defun 65B ( / blockName description x y )
	...
	(moveUp (halfOf y))
	(setLayer layer_Zero)
	(command "._PLINE" p11 p12 p14 p13 _closed_)
	(drawHatch _filledHatch_)
	(command "._PLINE" p21 p22 p24 p23 _closed_)
	(drawHatch _filledHatch_)
...
(defun 65C ( / blockName description x y )
	...
	(command "._PLINE" p21 p22 p24 p23 _closed_)
	(drawHatch _filledHatch_)
	(command "._PLINE" p31 p32 p34 p33 _closed_)
	(drawHatch _filledHatch_)
	(drawCircleAtPos layer_Zero r p99 _noWipeout_)
	(addDescriptionBelowOrigo description 0)
	(createSchematicBlockFromCurrentGraphics blockName)
...
(defun 65D ( / blockName description x y )
	...
	(moveUp (halfOf y))
	(setLayer layer_Zero)
	(command "._PLINE" p11 p12 p14 p23 p21 p22 p34 p33 _closed_)
	(drawHatch _filledHatch_)
	(addDescriptionBelowOrigo description 0)
	(createSchematicBlockFromCurrentGraphics blockName)
	(createGeoBlockInAllPaperScalesFromBlock blockName _one_ blockName)
...
(defun 65G-2 ( / blockName description x y r1 r2 y2 )
	...
	(drawHatchFromPoint _filledHatch_ p2 0 0)
	(addDescriptionBelowOrigo description 0)
	(createSchematicBlockFromCurrentGraphics blockName)
	(createGeoBlockInAllPaperScalesFromBlock blockName _one_ blockName)
	description ; Used if table is created
