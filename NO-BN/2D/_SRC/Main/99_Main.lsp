...
(defun C:MAIN ( / t0 t1 startTime endTime diffTime blocksPerSecond symbolLibraryFileName )
	...
	;(TraceLevel1 "26_GENERATE-SIGNALING-OBJECTS")				(26_GENERATE-SIGNALING-OBJECTS)
	...
	(setq 
		...
		symbolLibraryFileName	(strcat _ADM_ "-" (TODAY t1) "_" (TIME t1) "-2D" ".dwg")
	)
	(TraceLevel1 (strcat "Saving resulting blocks to file '" symbolLibraryFileName "'..."))
	(SAVE-RESULT symbolLibraryFileName)

	(TraceLevel1 "\n*** End of (C:MAIN adm) - 2D library has been generated ***\n")
