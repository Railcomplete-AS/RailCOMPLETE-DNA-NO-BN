...
(defun SKILT-ATC-INNKOBLET ( / blockName description x y p1 p2 )
	...
	(AddTextAtPoint layDef_Zero _th250_ p1    "ATC"   )
	(AddTextAtPoint layDef_Zero _th125_ p2 "INNKOBLET")
	(MoveUp (HalfOf y))
...
(defun SKILT-ATC-UTKOBLET ( / blockName description x y p1 p2 )
	...
	(DrawBox layDef_Zero x y layDef_BoardOrPole_Wipeout)
	(AddTextAtPoint layDef_Zero _th250_ p1    "ATC"  )
	(AddTextAtPoint layDef_Zero _th125_ p2 "UTKOBLET")
	(MoveUp (HalfOf y))
	(AddDescriptionBelowOrigin description 0)
	(CreateSchematicBlockFromCurrentGraphics blockName)
	(CreateAnnotativeBlockFromScaledSchematicBlock blockName _one_)
...
(defun SKILT-ATC-SLUTTER ( / blockName description x y p1 p2 )
	...
	(DrawBox layDef_Zero x y layDef_BoardOrPole_Wipeout)
	(AddTextAtPoint layDef_Zero _th250_ p1   "ATC"  )
	(AddTextAtPoint layDef_Zero _th125_ p2 "SLUTTER")
	(MoveUp (HalfOf y))
	(AddDescriptionBelowOrigin description 0)
	(CreateSchematicBlockFromCurrentGraphics blockName)
	(CreateAnnotativeBlockFromScaledSchematicBlock blockName _one_)
