...
(defun SKILT-SIDESPOR ( / blockname description x y attSidingName attKm attBetweenStations )
	...
	(AddTextAttributeAtPoint layDef_Zero _th070_ (Pos51 y) attSidingName)
	(AddTextAtPoint          layDef_Zero _th050_ (Pos52 y) "sidespor")
	(AddTextAttributeAtPoint layDef_Zero _th070_ (Pos53 y) attKm)
	(AddTextAtPoint          layDef_Zero _th050_ (Pos54 y) "mellom stasjonene")
	(AddTextAttributeAtPoint layDef_Zero _th070_ (Pos55 y) attBetweenStations)
	(MoveUp (HalfOf y))
