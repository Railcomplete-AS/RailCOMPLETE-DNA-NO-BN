...
(defun SKILT-ARBEIDSOMRAADE-3 ( / blockName description x y att1 att2 att3 att4 att5 att6 )
	...
	(DrawBox layDef_Zero x y layDef_BoardOrPole_Wipeout)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos61 y) att1)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos62 y) att2)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos63 y) att3)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos64 y) att4)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos65 y) att5)
	(AddTextAttributeAtPoint layDef_Zero _th125_ (Pos66 y) att6)
	(MoveUp (HalfOf y))
	(AddDescriptionBelowOrigin description 0)
	(CreateSchematicBlockFromCurrentGraphics blockName)
	(CreateAnnotativeBlockFromScaledSchematicBlock blockName _one_)
