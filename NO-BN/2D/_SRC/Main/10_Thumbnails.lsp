...
(defun 10_GENERATE-THUMBNAILS ( / )
	...
	(TraceLevel2 "THUMBNAIL-PLATFORM-ELEMENT-LEFT")			(THUMBNAIL-PLATFORM-ELEMENT "LEFT")
	(TraceLevel2 "THUMBNAIL-PLATFORM-ELEMENT-RIGHT")		(THUMBNAIL-PLATFORM-ELEMENT "RIGHT")
