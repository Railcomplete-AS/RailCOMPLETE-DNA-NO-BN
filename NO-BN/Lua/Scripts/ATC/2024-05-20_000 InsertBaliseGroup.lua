...
writeln(string.format("Alignment: %s, dir:= %s, Km: %s, groupType: %s, configuration: %s / %s / %s / %s",RC__identify(alg),dir,RC__toKm(km),groupType,configP,configA,configB,configC))
