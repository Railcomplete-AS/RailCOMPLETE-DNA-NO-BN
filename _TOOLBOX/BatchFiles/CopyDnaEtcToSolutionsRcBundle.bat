echo off
rem Copyright (c) 2015-2025 Railcomplete AS, Norway, NO916118503
...
:Noecho
	...
	echo - Lua scripts, snippets and Tooltips (Lua and XAML code):
	echo d | xcopy /Y /E /I /exclude:..\xcopyignore.txt ..\%ADM%\Lua    "..\..\Solutions\RC.bundle\Adm\%ADM%\Lua"

	echo - Psets:
	echo d | xcopy /Y /E /I /exclude:..\xcopyignore.txt ..\%ADM%\Psets    "..\..\Solutions\RC.bundle\Adm\%ADM%\Psets"
