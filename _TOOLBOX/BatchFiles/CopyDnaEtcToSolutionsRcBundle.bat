echo off
echo     ENTER CopyDnaEtcToSolutionsRcBundle.bat
...
echo          .
echo          to the folder/subfolders used by the build machine producing a release from RC.Bundle:
echo          ...\Github\RailCOMPLETE\Solutions\RC.bundle\XX-XX
echo          .
